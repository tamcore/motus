...
// guardrailMaxTokens caps the classifier completion — it only ever needs to
// emit ON_TOPIC or OFF_TOPIC.
const guardrailMaxTokens = 4
...
func (s *Service) classifyTopic(ctx context.Context, msgs []Message) (bool, error) {
	...
	return strings.Contains(reply, "OFF_TOPIC"), nil
}
